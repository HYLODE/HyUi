-- Refactored version from api/src/api/census/last_open_bed_admits.sql
-- Credits to Harry Moss
...
beds AS (
	...
	WHERE
-- 	    TODO: Use api.wards to inject departments and locations in, instead of hardcoded approach
		(
		dept.name IN
