...
On MacOS you will likely need to add the environment variable `OBJC_DISABLE_INITIALIZE_FORK_SAFETY=YES` to the `code/web` debugging process to stop a crash. This is due to a bug in the way the Dash background callback system works.
