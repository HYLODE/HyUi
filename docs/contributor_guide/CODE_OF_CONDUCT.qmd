# Code of conduct for `hyui`

Contributors to this repository hosted by `HYLODE` are expected to follow the
...
- "Leadership", we mean both `HYLODE` organisation owners, line managers, and other
  leadership within the UCL-HAL.
...
[doc@steveharris.me][email-address]. All complaints will be
...
[email-address]: mailto:doc@steveharris.me
