...
-- This query is to pull aggregate numbers of obs for each patient
...
SELECT
  ...
  /*	CASE 
    ...
    */
    ...
    -- Now aggregate on ot.id_in_application
    COUNT(ot.id_in_application)
...
WHERE ob.observation_datetime > NOW() - '24 HOURS'::INTERVAL
...
GROUP BY ot.id_in_application, mrn.mrn
